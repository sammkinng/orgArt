    ...
    return (
        <View style={{ flexDirection: 'row' }}>
            <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={{ marginLeft: SIZES.base, color: COLORS.secondary}}>{label}</Text>
            </View>
            <View style={{ flex: 1, alignItems: 'flex-end' }}>
                <Text style={{ marginLeft: SIZES.base, color: COLORS.gray}}>{detail}</Text>
            </View>
        </View>
    )
}
...
const PlantDetail = ({ navigation }) => {
        ...
        return (
            ...
            >
                ...
                <View style={{ flexDirection: 'row', marginTop: "10%" }}>
                    <View style={{ flex: 1 }}>
                        <Text style={{ color: COLORS.white }}>Glory Mantas</Text>
                    </View>
    ...
    function renderFooter() {
        return (
            <View style={{ flex: 1, flexDirection: 'row', paddingVertical: SIZES.padding }}>
                ...
                >
                    <Text style={{ color: COLORS.white}}>Take Action</Text>
                ...
                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingHorizontal: SIZES.padding }}>
                    <Text style={{ flex: 1, color: COLORS.secondary}}>Almost 2 weeks of growing time</Text>
                    <Image
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Text style={{ paddingHorizontal: SIZES.padding, color: COLORS.secondary}}>Requirements</Text>
